...
const NavBar = () => {
  ...
  return (
    <header className="top-0 flex justify-center items-center py-5 w-full text-lg bg-opacity-50 border-b border-black">
      <div className={isOpenStyle}>
        <a href="https://www.linkedin.com/in/sushant-tripathee-94a753280/">
          <img
            className="rounded-full size-14 transform transition-all duration-200 hover:scale-110 md:size-12"
        ...
        <nav className={isOpenStyleNav}>
          <a className="hover:underline hover:text-[#df5e4d] mx-5">Home</a>
          <a className="hover:underline hover:text-[#df5e4d] mx-5">Skills</a>
          <a className="hover:underline hover:text-[#df5e4d] mx-5">Projects</a>
          <a className="hover:underline hover:text-[#df5e4d] mx-5">Contacts</a>
        </nav>
